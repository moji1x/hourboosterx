    ...
    {	
    	...
    	bot.on('error', function(e) {
    		...
    		setTimeout(function() {bot.doLogin();}, 30*600*1000);
    	});
    	...
    	bot.on("friendMessage", function(steamID, message) {
    		...
    		if ( !this.messageReceived[steamID] ) {
    			bot.chatMessage(steamID, "[Group] https://steamcommunity.com/groups/HVHMEPUSSSY");
    			bot.chatMessage(steamID, "/code [INFO] This message was sent automatically from mine idler service by Moji");
    			bot.chatMessage(steamID, "[Discord] https://discord.gg/bBacxnk");
    			bot.chatMessage(steamID, "/code [Discord]Moji#5011");
    			bot.chatMessage(steamID, "/code [TeamSpeak]5.200.25.14:1934");
